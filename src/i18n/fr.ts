const fr = {
  nav: {
    ...
    lorem: 'Lorem Ipsum',
    randomHex: 'Hexadécimal Aléatoire',
  ...
  home: {
    ...
    subtitle: 'Des outils pensés par nos équipes — pour vos projets print, digital & design.',
    heroText: "getinside accompagne les marques et enseignes dans le Retail Media. Ces outils, on les a créés pour nous-mêmes — et on a décidé de les partager. Gratuits, sans compte, tout tourne dans votre navigateur.",
    ...
    browse: {
      ...
      subtitle: 'Des outils gratuits pour vos projets print, digital & design.',
    },
    categories: {
      all: 'Tous',
      print: 'Print',
    ...
    tools: {
      ...
      randomHex: { title: 'Hexadécimal Aléatoire', desc: 'Générez des chaînes hexadécimales aléatoires.' },
      ...
      qrCreator: { title: 'Générateur QR Code', desc: 'Créez des QR codes personnalisés avec couleurs et logo.' },
  ...
  redirectChecker: {
    ...
    placeholder: 'https://example.com/lien-ou-raccourci',
    check: 'Vérifier',
    checking: 'Vérification…',
    resultTitle: 'Résultat',
    summaryTitle: 'Destination finale',
    finalUrlLabel: 'URL finale',
    totalHops: '{n} redirection(s) détectée(s)',
    noRedirect: 'Aucune redirection — cette URL pointe directement vers sa destination.',
    chainTitle: 'Chaîne de redirections',
    error: {
  ...
  colorPalette: {
    ...
    copied: 'Copié !',
    selectColor: 'Sélectionnez une couleur pour l\'ajuster',
    ...
    toast: {
      ...
      jsonCopied: 'Palette JSON copiée dans le presse-papiers',
    },
    shortcut: 'Raccourci',
    full: {
      ...
      harmony: {
        ...
        triadic: 'Triadique',
        tetradic: 'Tétradique',
        splitComplementary: 'Split compl.',
  ...
  mockupGenerator: {
    title: 'Générateur de mockup',
    desc: 'Intégrez votre capture d\'écran dans un mockup de device.',
    about: 'Un mockup de device met votre capture ou design en contexte, le rendant immédiatement plus présentable pour des clients, présentations ou réseaux sociaux. Cet outil intègre votre image dans un cadre de device directement dans le navigateur — sans Photoshop.',
    ...
    devices: {
      ...
      xps13: 'XPS 13',
      xps15: 'XPS 15',
      applewatch41mm: 'Apple Watch 41mm',
      watchseries5: 'Watch Series 5 40mm',
      galaxywatch4: 'Galaxy Watch 4',
      lg55: 'LG 55"',
      samsungd8000: 'Samsung 55"',
    },
    pedagogic: {
  ...
  colorConverter: {
    ...
    desc: 'Convertissez des couleurs entre les formats HEX, RGB, HSL, CMYK, OKLCH, LAB et LCH.',
    about: "Les espaces colorimétriques servent des usages différents : HEX/RGB/HSL pour le web, CMYK pour l'impression, OKLCH/LAB/LCH pour la science des couleurs et les systèmes de design accessibles. Cet outil convertit instantanément entre tous ces formats, avec un aperçu de lisibilité et des couleurs harmoniques.",
    inputLabel: 'Couleur',
    hexPlaceholder: '#0aaa8e',
    randomColor: 'Aléatoire',
    webSection: 'Web & Écran',
    ...
    pedagogic: {
      ...
      description: 'Chaque format de couleur a un usage spécifique. OKLCH et LAB sont perceptuellement uniformes — une même variation numérique produit une variation visuelle constante.',
      tips: [
        'HEX (#RRGGBB) est le standard web',
        'RGB (0–255) pour les écrans',
        'HSL est intuitif pour ajuster teinte/saturation/luminosité',
        'CMYK (0–100 %) pour l\'impression professionnelle',
        'OKLCH est perceptuellement uniforme — idéal pour les palettes accessibles',
        'LAB/LCH sont utilisés en science des couleurs et gestion de couleur ICC',
      ],
    },
  },
  imageCompressor: {
  ...
  randomHex: {
    title: 'Générateur Hexadécimal Aléatoire',
    desc: 'Générez des chaînes hexadécimales aléatoires.',
    about: 'Générez des valeurs hexadécimales aléatoires pour vos tests et développements. Utile pour créer des identifiants uniques, des hashes MD5 (32 chiffres) ou SHA1 (40 chiffres).',
  ...
  metadata: {
    ...
    cameraInfo: 'Informations de l\'Appareil',
    captureSettings: 'Paramètres de Capture',
    gpsLocation: 'Localisation GPS',
    iptcMetadata: 'Métadonnées IPTC',
    colorProfile: 'Profil Colorimétrique',
    ...
    exif: {
      ...
      exposureProgram: 'Mode d\'exposition',
    ...
    icc: {
      ...
      renderingIntent: 'Intent de rendu',
    },
    pedagogic: {
  ...
  qrCreator: {
    title: 'Créateur QR Code',
    desc: 'Générez des QR codes personnalisés avec colours, logo et plus.',
    about: "Les QR Codes (Quick Response Codes) sont des codes-barres 2D lisibles par smartphone. Cet outil vous permet de créer des QR codes personnalisés avec différentes couleurs, un logo centré, et plusieurs formats de sortie. Vous pouvez générer des QR codes pour des URL, du texte, des identifiants WiFi, ou des cartes de contact vCard.",
    tabUrl: 'URL',
    tabText: 'Texte',
    tabWifi: 'WiFi',
    tabVcard: 'vCard',
    ...
    wifiSsidPlaceholder: 'MonWiFi',
    wifiPassword: 'Mot de passe',
    wifiPasswordPlaceholder: 'Mot de passe WiFi',
    wifiEncryption: 'Chiffrement',
    wifiNone: 'Aucun',
    ...
    vcardAddress: 'Adresse',
    vcardUrl: 'Site web',
    customization: 'Personnalisation',
    size: 'Taille',
    errorCorrection: 'Correction erreur',
    ...
    dotRounded: 'Arrondi',
    dotClassy: 'Classy',
    dotClassyRounded: 'Classy Arrondi',
    dotExtraRounded: 'Extra Arrondi',
    cornerSquareStyle: 'Coins carrés',
    cornerDotStyle: 'Coins ronds',
    cornerSquare: 'Carré',
    cornerDot: 'Point',
