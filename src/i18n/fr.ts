const fr = {
  ...
  contrastChecker: {
    ...
    preview: 'Aperçu',
    previewAria: 'Aperçu avec texte {text} sur fond {bg}, ratio {ratio}:1',
    previewSize: 'Taille de l\'aperçu',
    previewHeading: 'Titre Principal',
    previewBody: 'Texte corporel pour la lisibilité',
    ...
    summary: {
      passAll: 'Tous les critères WCAG 2.1 sont satisfaits',
      someFail: 'Certains critères WCAG 2.1 ne sont pas satisfaits',
    },
    apca: {
      note: 'Algorithme de Contraste Perceptuel Avancé',
      bodyPreferred: 'Recommandé pour le texte corporel',
      bodyMinimum: 'Minimum pour le texte corporel',
