...
const en: Messages = {
  ...
  home: {
    ...
    subtitle: 'Tools built by our teams — for print, digital & design workflows.',
    heroText: 'getinside helps brands and retailers with Retail Media. These tools started as internal utilities — then we decided to share them. Free, no account needed, everything runs in your browser.',
    ...
    browse: {
      title: 'All tools',
      subtitle: 'Free tools for your print, digital & design projects.',
    },
    categories: {
      all: 'All',
      print: 'Print',
    ...
    tools: {
      ...
      randomHex: { title: 'Random Hex', desc: 'Generate random hexadecimal strings.' },
      ...
      qrCreator: { title: 'QR Code Generator', desc: 'Create custom QR codes with colors and logo.' },
  ...
  redirectChecker: {
    ...
    label: 'URL to check',
    placeholder: 'https://example.com/link-or-shortener',
    check: 'Check',
    checking: 'Checking…',
    resultTitle: 'Result',
    summaryTitle: 'Final Destination',
    finalUrlLabel: 'Final URL',
    totalHops: '{n} redirect(s) detected',
    noRedirect: 'No redirect — this URL points directly to its destination.',
    chainTitle: 'Redirect Chain',
    error: {
  ...
  colorPalette: {
    ...
    unlock: 'Unlock',
    copied: 'Copied!',
    selectColor: 'Select a color to adjust',
    ...
    toast: {
      ...
      jsonCopied: 'Palette JSON copied to clipboard',
    },
    shortcut: 'Shortcut',
    full: {
      title: 'Color Palette',
  ...
  mockupGenerator: {
    ...
    desc: 'Drop your screenshot into a device mockup.',
    about: 'A device mockup puts your screenshot or design into context, making it instantly more presentable for clients, presentations, or social media. This tool composites your image into a device frame directly in the browser — no Photoshop required.',
  ...
  colorConverter: {
    ...
    desc: 'Convert colors between HEX, RGB, HSL, CMYK, OKLCH, LAB, and LCH formats.',
    about: "Color spaces serve different purposes: HEX/RGB/HSL for the web, CMYK for print, OKLCH/LAB/LCH for color science and accessible design systems. This tool converts instantly between all of them, with readability preview and harmonic color suggestions.",
    inputLabel: 'Color',
    hexPlaceholder: '#0aaa8e',
    randomColor: 'Random',
    webSection: 'Web & Screen',
    printSection: 'Print',
    ...
    pedagogic: {
      ...
      description: 'Each color format has a specific use. OKLCH and LAB are perceptually uniform — the same numeric step produces a consistent visual change.',
      tips: [
        'HEX (#RRGGBB) is the web standard',
        'RGB (0–255) for screens',
        'HSL is intuitive for adjusting hue/saturation/lightness',
        'CMYK (0–100%) for professional printing',
        'OKLCH is perceptually uniform — ideal for accessible palettes',
        'LAB/LCH are used in color science and ICC color management',
      ],
    },
  },
  imageCompressor: {
  ...
  randomHex: {
    ...
    desc: 'Generate random hexadecimal strings.',
    about: 'Generate random hexadecimal values for testing and development. Useful for creating unique identifiers, MD5 hashes (32 digits) or SHA1 hashes (40 digits).',
  ...
  qrCreator: {
    ...
    desc: 'Generate custom QR codes with colors, logo and more.',
    about: 'QR codes (Quick Response codes) are 2D barcodes readable by smartphone. This tool lets you create custom QR codes with different colors, centered logo, and multiple output formats. You can generate QR codes for URLs, text, WiFi credentials, or vCard contact cards.',
    tabUrl: 'URL',
    tabText: 'Text',
    tabWifi: 'WiFi',
    tabVcard: 'vCard',
    ...
    cornerSquareStyle: 'Corner squares',
    cornerDotStyle: 'Corner dots',
    cornerSquare: 'Square',
    cornerDot: 'Dot',
